...
contract ERC721PhaseIIIPreAuthUpgradeable is
    Initializable,
    OwnableUpgradeable,
    ...
    EIP712Upgradeable
{
    ...
    bytes32 public constant MINT_AUTH_TYPE_HASH =
        keccak256("MintAuth(address to,uint256 tokenId,uint256 amount,uint256 nonce,uint256 expiry)");
    ...
    function __ERC721PreAuth_init_unchained(
        ...
        __EIP712_init_unchained("OKXMint", "1.0");
    ...
    function isMintAuthorized(
        ...
        bytes32 mintAuthHash = keccak256(abi.encode(MINT_AUTH_TYPE_HASH, to, tokenId, amount, nonce, expiry));
    ...
    function _safeMint(
        ...
        _checkMintAuthorization(to, tokenId, amount, nonce, expiry, signature);
    ...
    function getHash(
        ...
        return keccak256(abi.encode(MINT_AUTH_TYPE_HASH, to, tokenId, amount, nonce, expiry));
    }
